...
def test_push_single_rhba_advisory_single_build(prepare_single_build, testdata_pub):
    ...
    logging.info("[CASE] test_push_single_rhba_advisory_single_build is called")

    logging.debug("[TEST DATA] return %s", str(prepare_single_build))
...
def test_push_single_rhsa_advisory_to_published_repos(
    ...
    logging.info("[CASE] test_push_single_rhsa_advisory_to_published_repos is called")

    logging.debug("[TEST DATA] return %s", str(prepare_published_repos))
